...
const Agence = () => {
  ...
  useEffect(() => {
    const preloadImages = imageArray.map((src) => {
  ...
  return (
    <div className='overflow-x-hidden'>
      ...
      <div className='section1 py-1 '>
        ...
        <div>
          {/* 1. IMAGE DIV: Mobile pe chota aur center mein, Laptop pe tera original (left-100, h-65) */}
          <div ref={imageDivRef} className='absolute h-40 w-32 top-20 left-1/2 -translate-x-1/2 lg:h-65 lg:w-50 overflow-hidden lg:top-40 lg:left-100 lg:translate-x-0 rounded-2xl lg:rounded-3xl'>
            <img ref={imageRef} className='h-full w-full object-cover' src="https://k72.ca/images/teamMembers/Carl_480x640.jpg?w=480&h=640&fit=crop&s=f0a84706bc91a6f505e8ad35f520f0b7" alt="" />
          </div>

          <div className='font-[font2] relative'>

            {/* 2. HEADING: Mobile pe thoda upar rakha hai, Laptop pe tera mt-[59vh] */}
            <div className='mt-[45vh] lg:mt-[59vh]'>
              <h1 className='text-[22vw] lg:text-[20vw] text-center leading-[20vw] lg:leading-[18vw]'>SEVEN7Y <br /> TWO</h1>
            </div>

            {/* 3. PARAGRAPH: Mobile pe text-xl aur normal padding, Laptop pe text-6xl aur pl-[40%] */}
            <div className='px-4 mt-8 lg:mt-0 lg:pl-[40%] lg:pr-1'>
              <p className='text-xl sm:text-3xl lg:text-6xl text-justify lg:text-left'>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 lg:grid-rows-2 px-6 lg:px-30 mt-24 lg:mt-60 space-x-0 lg:space-x-9 space-y-12 lg:space-y-40 font-[font2] lg:pl-35">
          <div className="text-xl font-bold lg:font-normal">Expertise</div>
          {/* Mobile pe normal width, Laptop pe teri w-10 */}
          <div className="text-lg lg:text-xl w-full lg:w-10 leading-snug">Strategy Advertising Branding Design Content</div>
          {/* Ye empty div 3-column ke liye tha. Mobile pe isko hide kiya hai taaki faltu gap na aaye */}
          <div className="hidden lg:block"></div>
          <div className="text-base sm:text-lg lg:text-xl text-justify lg:text-left">Our Work_ Born in curiosity, raised by dedication and fed with a steady diet of creativity.</div>
          <div className="text-base sm:text-lg lg:text-xl text-justify lg:text-left">Our Creative_ Simmering in an environment where talent can come to a full boil. Encouraged to become the best versions of ourselves.</div>
          <div className="text-base sm:text-lg lg:text-xl text-justify lg:text-left">Our Culture_ We’re open to each other. Period. The team works together to create a space that makes us proud.</div>
        </div>
        ...
        <div ref={blackPageRef} className='text-[#D3FD50] mt-16 lg:mt-30 flex flex-col overflow-hidden h-screen w-full justify-center items-center relative firstPage z-10'>

          {/* 1. TOP MARQUEE: Mobile pe text-[60px] aur gap-10, Laptop pe tera original text-[150px] aur gap-200 */}
          <div className='top-marquee absolute top-5 lg:top-10 left-0 flex m-4 lg:m-12 whitespace-nowrap gap-10 lg:gap-200'>
            <p className='font-[font2] text-[60px] lg:text-[150px]'>MAELLE</p>
            <p className='font-[font2] text-[60px] lg:text-[150px]'>MAELLE</p>
            <p className='font-[font2] text-[60px] lg:text-[150px]'>MAELLE</p>
            <p className='font-[font2] text-[60px] lg:text-[150px]'>MAELLE</p>
            <p className='font-[font2] text-[60px] lg:text-[150px]'>MAELLE</p>
          ...
          {/* 2. CENTER IMAGE: Mobile pe 70% width, Laptop pe teri original 30% width */}
          <div className='flex justify-center items-center h-full w-full'>
            <img
              ref={page1ImgRef}
              className="w-[70%] sm:w-[50%] lg:w-[30%] rounded-2xl lg:rounded-3xl relative"
              src="https://k72.ca/images/teamMembers/HugoJoseph_480x640.jpg?w=480&h=640&fit=crop&s=f152025b8a59b062d1e7978b5d6544c3"
              alt=""
            />
          </div>

          {/* 3. BOTTOM MARQUEE: Mobile pe position, text size aur spacing adjust ki hai */}
          <div className='bottom-marquee flex justify-center w-full h-full items-center gap-4 lg:gap-8 absolute bottom-0 lg:-bottom-28 left-0'>
            <p className='font-[font2] text-[50px] lg:text-[150px] whitespace-nowrap'>JACOT-DESCOMBES</p>
            <p className='font-[font2] text-sm sm:text-lg lg:text-3xl whitespace-nowrap pt-1 lg:pt-12'>OPERATIONS AND BUSINESS DEVELOPMENT</p>
            <p className='font-[font2] text-[50px] lg:text-[150px] whitespace-nowrap'>JACOT-DESCOMBES</p>
            <p className='font-[font2] text-sm sm:text-lg lg:text-3xl whitespace-nowrap pt-1 lg:pt-12'>OPERATIONS AND BUSINESS DEVELOPMENT</p>
            <p className='font-[font2] text-[50px] lg:text-[150px] whitespace-nowrap'>JACOT-DESCOMBES</p>
            <p className='font-[font2] text-sm sm:text-lg lg:text-3xl whitespace-nowrap pt-1 lg:pt-12'>OPERATIONS AND BUSINESS DEVELOPMENT</p>
        ...
        <div ref={page2Ref} className='text-[#D3FD50] mt-16 lg:mt-30 overflow-hidden h-screen w-full relative secondPage z-20'>
          {/* 1. TOP MARQUEE: Mobile pe chota text aur kam gap, Laptop pe tera original */}
          <div className='top-marquee absolute top-5 lg:top-10 left-0 flex m-4 lg:m-12 whitespace-nowrap gap-10 lg:gap-200'>
            <p className='font-[font2] text-[60px] lg:text-[150px]'>MAELLE</p>
            <p className='font-[font2] text-[60px] lg:text-[150px]'>MAELLE</p>
            <p className='font-[font2] text-[60px] lg:text-[150px]'>MAELLE</p>
          ...
          {/* 2. CENTER IMAGE: Mobile pe thodi badi, Laptop pe teri 30% width */}
          <div className='flex justify-center items-center relative h-full w-full'>
            <img
              ref={page2ImgRef}
              className='w-[70%] sm:w-[50%] lg:w-[30%] rounded-2xl lg:rounded-3xl'
              src="https://k72.ca/images/teamMembers/MEGGIE_480X640_2.jpg?w=480&h=640&fit=crop&s=3604b19f8fc7b40f517954147698d847"
              alt=""
            />
          </div>
          {/* 3. BOTTOM MARQUEE: Mobile pe spacing, positioning aur font size set kiya hai */}
          <div className='bottom-marquee flex justify-center w-full h-full items-center gap-4 lg:gap-8 absolute bottom-0 lg:-bottom-28 left-0'>
            <p className='font-[font2] text-[50px] lg:text-[150px] whitespace-nowrap'>JACOT-DESCOMBES</p>
            <p className='font-[font2] text-sm sm:text-lg lg:text-3xl whitespace-nowrap pt-1 lg:pt-12'>OPERATIONS AND BUSINESS DEVELOPMENT</p>
            <p className='font-[font2] text-[50px] lg:text-[150px] whitespace-nowrap'>JACOT-DESCOMBES</p>
